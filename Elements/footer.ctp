<section id="footer">
    ...
    <div style="margin-right:0;margin-left:0" class="row mb-4">
        <div class="col-md-4">

            <?php if ($theme_config['footer']->disable_vote) { ?>
                <div class="text-center">
                    ...
                    <div class="text-center">
                        <?php if (!empty($theme_config['footer']->un->titre)): ?>
                            <div class="fa fa-angle-double-right text-white"></div>
        ...
        <div class="col-md-4">
            ...
            <?php } else { ?>
                <div class="right-footer w-100 text-center">
                    <div class="title-footer">
                        Informations
                    </div>
